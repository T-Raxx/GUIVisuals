...
T.truthy(flags["World_AmbientColor"] and flags["World_AmbientColor_Fade"] and flags["World_AmbientColor_2"], "Ambient tiene CF (color/fade/2)")
T.truthy(flags["World_Ambient"] == true, "toggle Ambient existe")
